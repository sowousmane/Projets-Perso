	...
	<div class="container">
		<div class="row">
			<div class="col-6">
				...
				<div id="score" style="position: relative;top: 40px; left: 100px; background-color: rgb(165, 231, 211);
...
<script>
	...
	$(function () {
		$('.bouton').on('click', function () {
			...
			var idRandom = getRndInteger(24,27);
	if (idRandom>23 && idRandom<28) {
		$.ajax({
                    url:'AmeriqueCurieuxRequetes.php',
                    type:'post',
                    data:{sow:idRandom},
...
<script>
	...
	function onMapClick(e) {
		...
		"<br/>en GeoJSON: " + coordGeoJSON(e.latlng,7) +
			"<br/>Niveau de  Zoom: " + map.getZoom().toString())
		.openOn(map);
        ...
        var ligne = L.polyline(EntreAetB,{color: 'red'}).addTo(map);
			...
			map.setView(pointA, 3);
			L.geoJSON(panama, {color:'green' }).addTo(map);
        var ligne = L.polyline(EntreAetB,{color: 'red'}).addTo(map);
		}
